...
- (void)viewDidLoad {
    ...
    _textView = [[UITextView alloc]initWithFrame:CGRectMake(16, 100, SCREEN_WIDTH-32, 100)];
    _textView.delegate = self;
    _textView.backgroundColor = [UIColor lightGrayColor];
    [self.view addSubview:_textView];
    
    _imageArray = [NSMutableArray array];
    _editv = [[UIView alloc] initWithFrame:CGRectMake(15, 200, SCREEN_WIDTH-15*2, 0)];
    ...
    _editv.frame = CGRectMake(15, 240, SCREEN_WIDTH-15*2, CGRectGetMaxY(_addPic.frame)+20);
...
- (void)nineGrid
{
    ...
    CGFloat width = 70;
    CGFloat widthSpace = (SCREEN_WIDTH - 15*4 - 70*4) / 3.0;
